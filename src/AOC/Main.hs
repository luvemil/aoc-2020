...
import qualified AOC.A22.ES10 as A22E10
import qualified AOC.A22.ES11 as A22E11
...
chooseAction (A22E10 fp) = A22E10.main fp
chooseAction (A22E11 fp) = A22E11.main fp
